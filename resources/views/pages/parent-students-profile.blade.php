            ...
            <div class="row">
              <dl class="dl-horizontal">
                <dt style="text-align: left; white-space: normal;">
                  <img src="{{ URL::asset('public/uploads/images/'. $student->img_url)}}">
                </dt> 
          ...
          <div class="white-box p-l-20 p-r-20">
            <div class="row">
              <dl class="dl-horizontal">
                ...
                <dt style="text-align: left; white-space: normal;">Parent Name: </dt> <dd><a href="{{ url('/teacher/parent/profile/'. $student->parent($student->id)) }}">{{ $student->parent_name }}</a></dd> <br></br>
