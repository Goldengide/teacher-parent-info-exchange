  ...
  <div id="page-wrapper">
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="white-box">
            <h3 class="box-title m-b-0">Teacher</h3>
            <p class="text-muted m-b-30"><a href="{{url('/super-admin/teacher/upload')}}">Upload New Teachers</a></p>
            <p class="text-muted m-b-30"><a href="{{url('/super-admin/teacher/new')}}">Add New Teacher</a></p>
